...
PARAM$finalmodel$num_iterations <- 500
PARAM$finalmodel$learning_rate <- 0.0246898670066916
PARAM$finalmodel$feature_fraction <- 0.412812248193228
PARAM$finalmodel$min_data_in_leaf <- 716
PARAM$finalmodel$num_leaves <- 622
