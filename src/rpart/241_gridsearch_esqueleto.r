...
PARAM$semillas <- c(980071, 980081, 980107, 980117, 980131)
...
archivo_salida <- "./exp/HT2020/gridsearch_v3.txt"
...
# for (vmax_depth in c(6, 8, 10, 12, 14)) {
  # for (vmin_split in c(400, 800, 600, 400, 200, 100, 50, 20, 10)) {
  for (vmin_split in seq(350,400,20)) {
    # for (vminbucket in unique(as.integer(vmin_split*c(4/5,3/4,1/2,1/4,1/5)))) {
    for (vminbucket in unique(as.integer(vmin_split*seq(10,90,10)/100))) {
      # for (vcp in seq(-15,20,5)/10) {
      for (vcp in c(-1)) {
